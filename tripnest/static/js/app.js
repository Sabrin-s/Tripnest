...
// =========================================================
//  💬 AI CHAT WIDGET — Floating Drawer Toggle
// =========================================================
(function initAiChatWidget() {
  ...
  const container = document.getElementById('aiChatWidgetContainer');

  if (!toggleBtn || !drawer) return;

  function openDrawer() {
    drawer.classList.remove('hidden');
    void drawer.offsetWidth; // reflow to trigger transition
  ...
  document.addEventListener('click', function(e) {
    if (drawer.classList.contains('open') && container && !container.contains(e.target)) {
      closeDrawer();
    }
  });
})();
